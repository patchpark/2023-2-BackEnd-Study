...
import com.example.GDSC__8th_HW.domain.DTO.DoctorDTO;
...
import com.example.GDSC__8th_HW.repository.DoctorRepository;
import com.example.GDSC__8th_HW.repository.MedicalDepartmentRepository;
import com.example.GDSC__8th_HW.repository.PatientRepository;
import com.example.GDSC__8th_HW.repository.ReservationRepository;
...
public class ReservationService {
    ...
    public void updateReservation(Long id, ReservationUpdateDTO reservationUpdateDTO){
        ...
        reservation.updateReservation(reservationUpdateDTO.getTime());
    }
